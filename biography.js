module.exports = {
  en: {
    ...
    bio: [
      ...
      'Harjanteen soittoa leimaa kokonaisvaltainen musikaalisuus, jossa vaikuttavalla tavalla yhdistyvät instrumentin täydellinen hallinta, rikas ilmaisu ja silkkisen soljuva ääni. Hänen virtuoosinen instrumenttinsa käsittely nosti hänet maailman vaskimuusikoiden kermaan viimeistään yhteisessä esiintymisessä ja levytyksessä Kiri Te Kanawan kanssa Englannissa joulukuussa 1994 sekä Rodion Shchedrinin trumpettikonserton Euroopan kantaesityksessä Moskovassa syksyllä 1995. Nykyisin solistiesiintymiset vievät häntä ympäri maailmaa.',

      'Runsaan levytystuotantonsa, pelkästään soololevyjä on jo yli 35 kappaletta, ohella Harjanne on esiintynyt laajalti myös radiossa ja televisiossa. Levytyksillään Harjanne on saavuttanut maineen kaikkein vaikeimpien trumpettikappaleiden levyttäjänä (mm. Zimmermannin, Grunerin, Nagaon, Schedrinin ja Jolivetin konsertot). Klassisen ja modernin musiikin kattavalla laajalla repertuaarillaan Harjanne on nostanut instrumenttinsa mainetta monipuolisena soolosoittimena. Harjanne on menestyksekkäästi kantaesittänyt lukuisia suomalaisten ja kansainvälisten säveltäjien trumpettiteoksia. Monet säveltäjät ovat myös omistaneet hänelle sävellyksiään ja tunnetut kapellimestarit (mm. Kamu, Kadhize, Miller, Oramo, Panula, Salonen, Saraste, Segerstam ja Vänskä) johtaneet esiintymisiä ja levytyksiä.',
  ...
  jp: {
    ...
    bio: [
      ...
      'ヨウコ・ハルヤンネ　使用楽器　:　バック・ストラディヴァリウス　トランペット　Bb管、C管'
    ],
  },
};
